    ...
    $.fn.imageUploader = function (options) {
        ...
        let createImg = function (src, id) {
            ...
            $button.on("click", function (e) {
                ...
                // Prevent browser default event and stop propagation
                prevent(e);
				// console.log( 'image index remove'+ $container.data('index') );
				...
				// console.log(  $container );
                   ...
                   $(".uploaded").find('.uploaded-image[data-index]').each(function (i, cont) {
                    ...
                    dataTransfer.items.remove( $container.data('index') );
        ...
        let fileSelectHandler = function (e) {
			...
			function myFunction(item, index) {
				var FileSize = item.size / 1024 / 1024; // in MB
				
				if(FileSize > 1){
					alert(item.name+' exceeds the 1MB image size limit');
					setPreview($container, '');
					$container.removeClass('has-files');
				}else{
					 setPreview($container, files[index]);
				}
			}
